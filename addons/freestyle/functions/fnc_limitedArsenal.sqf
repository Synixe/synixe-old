...
private _factions = ["Canada (Woodland)", "Police", "S.W.A.T."];
...
switch (_faction) do {
  case "Canada (Woodland)": {
    [
      ...
      "U_CAF_uniform1_MIX", "U_CAF_uniform1_MIX", "U_RCAF_146_HeliPilotCoveralls",
    ...
    [_lmgs, ["caf_c9a2", "caf_C9A2_wood"]] call FLAG_ADD_WEAPONS;
    [_at == 1 || {_at == 2}, [
