...
def main():
    ...
    print("""
  ######################################
  # Synixe Development Environment Setup #
  ######################################

  This script will create your Synixe dev environment for you.
  ...
  This script will create two hard links on your system, both pointing to your Synixe project folder:
    [Arma 3 installation directory]\\{} => Synixe project folder
    P:\\{}                              => Synixe project folder
